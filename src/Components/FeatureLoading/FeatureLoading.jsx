                ...
                <div class="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
                    <div class="w-full ">
                        <div class="flex flex-col items-center max-w-lg mx-auto text-center">
                            ...
                            <h1 class="mt-3 text-2xl font-semibold text-gray-800  md:text-3xl">we are working in this feature......</h1>
                            <p class="mt-4 text-gray-500 dark:text-gray-400">We are glad to having you. currently we are working in this feature. hope it will be available ASAP.</p>

                            <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                                <Link href={"/dashboard"} class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto ">
                        ...
                        <div class="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="p-6 rounded-lg bg-blue-50 dark:bg-gray-800">
                                ...
                                <p class="mt-2 text-gray-500 dark:text-gray-400 ">Cant find what youre looking for?</p>
