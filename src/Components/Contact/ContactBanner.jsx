    ...
    return (
        <section className="bg-white text-slate-900">
            <div className="container px-6 py-12 mx-auto">
                ...
                {/* Slider Section */}
                <div className="relative w-full h-96 mt-10 lg:h-96">
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2">
                    {['Chat to sales', 'Visit us', 'Call us'].map((title, index) => (
                        <div key={index} className="p-4 rounded-lg bg-blue-50 md:p-6 transition-transform transform hover:bg-blue-100 hover:border hover:border-blue-400 hover:scale-105">
                            ...
                            <h2 className="mt-4 text-base font-medium text-gray-800">{title}</h2>
