    ...
    return (
        <div>
            <span className="relative flex justify-center my-10 font-bold">
                ...
                <span className="relative z-10 px-6 text-2xl text-[#0077b6]">All Notifications</span>
            </span>

            <div className='my-10'>
                <div className="space-y-5 mx-8">
                    <div className="relative mx-auto max-w-full border-b border-b-[#00b4d8]  p-4 text-sm hover:bg-[#caf0f8] hover:rounded-md hover:border-[#03045e] ">
                        ...
                        <div className="flex space-x-4">
                            <div className="relative h-10 w-10">
                                <Image
                                    ...
                                    alt=""
                                    width={256}  // specify the width based on the image's size
                                    height={256} // specify the height based on the image's size
                                />
